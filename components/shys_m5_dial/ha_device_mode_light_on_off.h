        ...
        class HaDeviceModeLightOnOff: public esphome::shys_m5_dial::HaDeviceMode {
            protected:
                ...
                void showOnOffMenu(M5DialDisplay& display){
                    ...
                    gfx->setTextColor(LightOnOffMenuTextColor); //MAROON
                    gfx->setTextDatum(middle_center);

                    gfx->startWrite();                      // Secure SPI bus

                    gfx->fillRect(0, 0, width, height, currentValue>0?LightOnOffMenuBackColorOn:LightOnOffMenuBackColorOff); // YELLOW:RED
