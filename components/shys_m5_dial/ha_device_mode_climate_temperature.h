        ...
        class HaDeviceModeClimateTemperature: public esphome::shys_m5_dial::HaDeviceMode {
            protected:
                ...
                void showTemperatureMenu(M5DialDisplay& display){
                    ...
                    gfx->setTextColor(TemperatureMenuTextColor); //MAROON
                    gfx->setTextDatum(middle_center);
                    
                    gfx->startWrite();                      // Secure SPI bus

                    gfx->fillRect(0, 0, width, this->getDisplayPositionY(currentValue) , TemperatureMenuBackColorOff); //RED
                    gfx->fillRect(0, this->getDisplayPositionY(currentValue), width, height, TemperatureMenuBackColorOn); //YELLOW
